...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *Logging.Api*):
...
Execute unit tests
```
    cd "Logging.Api/test/Logging.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Logging.Api/src/Logging.Api"
